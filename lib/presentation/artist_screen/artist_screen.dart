import '../artist_screen/widgets/songs2_item_widget.dart';
...
class ArtistScreen extends StatefulWidget {
  ...
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => ArtistProvider(), child: ArtistScreen());
  }
}
    ...
    return Padding(
        ...
        child: Consumer<ArtistProvider>(builder: (context, provider, child) {
          return GridView.builder(
              ...
              itemCount: provider.artistModelObj.songs2ItemList.length,
              itemBuilder: (context, index) {
                Songs2ItemModel model =
                    provider.artistModelObj.songs2ItemList[index];
                return Songs2ItemWidget(model);
              });
        }));
  }
