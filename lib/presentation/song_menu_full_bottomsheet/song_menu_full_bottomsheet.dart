import '../song_menu_full_bottomsheet/widgets/optionslist1_item_widget.dart';
...
class SongMenuFullBottomsheetState extends State<SongMenuFullBottomsheet> {
  ...
  Widget _buildOptionsList(BuildContext context) {
    return Consumer<SongMenuFullProvider>(
      builder: (context, provider, child) {
        return ListView.separated(
          ...
          itemCount: provider.songMenuFullModelObj.optionslist1ItemList.length,
          itemBuilder: (context, index) {
            Optionslist1ItemModel model =
                provider.songMenuFullModelObj.optionslist1ItemList[index];
            return Optionslist1ItemWidget(
              model,
            );
          },
        );
